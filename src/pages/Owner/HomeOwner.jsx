        ...
        {loading || error ? (
          ...
          <div className="flex-col place-content-center xl:mx-20 2xl:mx-56 lg:mx-16 md:mx-12 sm:mx-8 mt-10 mx-8">
            <div className="flex justify-center">
              <div
                className="bg-blue-500 text-white rounded-3xl w-[21em] px-10 py-8 text-xl
            ...
            md:h-44 md:px-10 md:py-8 md:text-xl md:w-[28em]"
              >
                <p>Total Sales</p>
                <p className="mt-8 font-bold">{displayPrice}</p>
              </div>
            </div>
            <div
              className="flex mt-5 justify-center space-x-10
          2xl:space-x-40 xl:space-x-12 lg:space-x-8 md:space-x-12"
            >
              <div
                className="bg-white text-black rounded-2xl w-[12em] h-32 flex justify-start
            2xl:h-72 2xl:w-[40em]
            xl:h-60  xl:w-[32em]
            lg:h-48  lg:w-[22em]
            md:h-32  md:w-[16em]"
              >
                <div
                  className="flex mt-9 space-x-4 ml-7
              ...
              md:space-x-5 md:ml-7 md:mt-8"
                >
                  ...
                  md:text-lg"
                    ...
                    <p
                      className="text-lg text-neutral-800 font-bold mt-1
          ...
          2xl:space-x-40 xl:space-x-12 lg:space-x-8 md:space-x-12"
            ...
            md:h-32  md:w-[16em]"
              >
                <div
                  className="flex mt-6 space-x-4 ml-5
              2xl:space-x-18 2xl:ml-18 2xl:mt-24
              xl:space-x-12 xl:ml-14 xl:mt-[4em]
              lg:space-x-8 lg:ml-10 lg:mt-14
